...
import static case_module.caseData.ParentCaseData.getCaseRequestBody;
...
public class CreateCaseActions {
    ...
    private static RequestSpecification getRequestSpecification(String jsonPayload)
    {
    ...
    public static Response createTheCase(String jsonPayload) {
...
//        return createCase(caseData.getCaseBody().toString());
    ...
    public static Response emptyCaseNumber() {
        return createCase(caseData.emptyCaseNumber);
    }
    public static Response nullCaseNumber() {
        return createCase(caseData.nullCaseNumber);
    }



    public static Response nullCaseNumber1() {
        return createTheCase((String) getCaseRequestBody());
    }



    public static Response emptyCaseType() {
        return createCase(caseData.emptyCaseType);
    }
